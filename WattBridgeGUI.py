...
class WattBridgeSoftware ( wx.Frame ):
    '''Class that contains all of the main features of the Watt Bridge Software. Creates all of the 
    buttons, texts, check boxes etc that the user can interact with.'''
    def __init__( self, parent ):
        '''Constructor for WattBridgeSoftware.'''
...
class About ( wx.Frame ):
    '''Class that creates information about the Watt Bridge software. This can be selected in the manu bar
    of the 'WattBridgeSoftware' class and will be displayed in a seperate window.'''
    def __init__( self, parent ):
